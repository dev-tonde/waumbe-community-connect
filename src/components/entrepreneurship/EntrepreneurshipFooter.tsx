        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/80 mb-6">
              Empowering entrepreneurs through education, mentorship, and
          ...
          <div>
            ...
            {/* Social Media */}
            <div>
              <h5 className="text-sm font-semibold mb-3 text-gold">
                Follow Us
              </h5>
        ...
        <div className="border-t border-white/20 pt-8 mb-8">
          <div className="text-center">
            ...
            <p className="text-white/80 mb-6 max-w-2xl mx-auto">
              ...
              entrepreneurship programs, success stories, and funding
              opportunities.
            </p>
            <form
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  const res = await fetch(
                    `${base}/functions/v1/send-form-email`,
                    {
                      method: "POST",
            ...
            >
              ...
              <button
                type="submit"
                className="bg-gold text-foreground px-6 py-2 rounded-lg font-semibold hover:bg-gold/90 transition-colors"
              >
                Subscribe
              </button>
            </form>
