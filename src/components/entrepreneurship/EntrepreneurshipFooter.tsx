...
const EntrepreneurshipFooter = () => {
  ...
  const entrepreneurshipLinks = [
    ...
    { name: "Donate", href: "/entrepreneurship/donate" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold mb-4 text-gold">Waumbe Entrepreneurship</h3>
            <p className="text-white/80 mb-6">
              Empowering entrepreneurs through education, mentorship, 
          ...
          {/* Entrepreneurship */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-gold">Entrepreneurship</h4>
            <ul className="space-y-2">
              {entrepreneurshipLinks.map((link, index) => (
                <li key={index}>
                  <Link 
                    to={link.href} 
                    className="text-white/80 hover:text-gold transition-colors"
        ...
        <div className="border-t border-white/20 pt-8 mb-8">
          <div className="text-center">
            ...
            <p className="text-white/80 mb-6 max-w-2xl mx-auto">
              Subscribe to our newsletter for the latest updates on entrepreneurship programs, 
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center text-white/60 text-sm">
                Made with <Heart className="w-4 h-4 mx-1 text-red-400" /> for entrepreneurs
              </div>
            </div>
          </div>
        </div>
...
export default EntrepreneurshipFooter;